...
# !!! Main.UserApp is configured as an alias for Main.OscarsExplorer and you might encounter it in some tests
using Main.OscarsExplorer, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "OscarsExplorer tests" begin
  @includetests ARGS
end
